import '../stylesheets/AdminAddProductPage.css'
...
const AdminAddProductPage = () => {
    ...
    return (
        <div className="adminProductsAddView">
            <div className="sidenavbar-left">abc</div>
                ...
                <div className="add-Product">
                    ...
                    <form className="addProductform" onSubmit={handleCreateProduct}>
                        <div className="formUp">
                            ...
                            <div className="forminputs-add-Product">
                                <label htmlFor="ProductName" className='ProductKousa'>Product Images:</label>
                                <input className='ProductKousa-input'
                                    type="file"
                                    accept="image/*"
                                    multiple
                            ...
                            <div className="forminputs-add-Product">
                                <div className="featured-class">
                                    <label htmlFor="ProductName" class="cyberpunk-checkbox-label">Featured:</label>
                                    <input
